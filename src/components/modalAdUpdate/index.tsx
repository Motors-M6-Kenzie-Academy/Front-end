        ...
        <Container>
          <div className="modalAdUpdateBox">
            ...
            <div className="divFormUpdateAd">
              <form
                className="formUpadate"
                onSubmit={handleSubmit(onSubmitAdsUpdateFunc)}
              >
                ...
                <div className="vehicleType">
                  ...
                  <div className="buttonVehicleType">
                    ...
                    <button
                      type="button"
                      className="buttonStyle"
                      onClick={() => setTypeVehicle("motobike")}
                    >
                      Moto
                    </button>
                  </div>
